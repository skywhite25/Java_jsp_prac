    ...
    <div class="tm-main-container">
      <div class="tm-top-container">
        ...
        <nav id="tmNav" class="tm-nav">
          <a class="tm-navbar-menu" href="${path }/main/main.do">Home</a>
          <ul class="tm-nav-links">
            <li class="tm-nav-item active">
              <a href="${path }/notice/list.do" data-linkid="0" data-align="right" class="tm-nav-link">Notice</a>
            </li>
            <li class="tm-nav-item">
              <a href="${path }/image/list.do" data-linkid="1" data-align="right" class="tm-nav-link">Image</a>
            </li>
            <li class="tm-nav-item">
              <a
                href="${path }/qna/list.do"
                data-linkid="2"
                data-align="middle"
                class="tm-nav-link">Q&amp;A</a>
            </li>
            <li class="tm-nav-item">
              <a href="${path }/message/list.do" data-linkid="3" data-align="left" class="tm-nav-link">Message</a>
            </li>
          </ul>
        </nav>
        ...
        <header class="tm-site-header-box tm-bg-dark">
          <h1 class="tm-site-title">#OOTD</h1>
          <p class="mb-0 tm-site-subtitle">customized styling</p>
        </header>
      </div>
      <!-- tm-top-container -->
