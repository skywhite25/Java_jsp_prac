						...
						<div class="form-row">
							...
							<div class="form-group col-sm-4">
								...
								<select name="semesterDivide" class="form-control">
									<option name="1학기" selected="selected">1학기</option>
									<option name="여름학기">1학기</option>
									<option name="2학기">1학기</option>
									<option name="겨울학기">1학기</option>
								</select>
							</div>
							<div class="form-group col-sm-4">
								<label>강의구분</label>
								<select name="lectureDivide" class="form-control">
									<option name="전공" selected="selected">전공</option>
