...
//	}
	...
	//이미지 게시판
	authMap.put("/image/writeForm.do", 9);
	authMap.put("/image/write.do", 9);
	authMap.put("/image/updateForm.do", 9);
	...
	//타임라인
	authMap.put("/timeline/writeForm.do", 1);
	authMap.put("/timeline/write.do", 1);
	authMap.put("/timeline/update.do", 1);
	authMap.put("/timeline/updateForm.do", 1);
	authMap.put("/timeline/updateFile.do", 1);
	authMap.put("/timeline/delete.do", 1);
	
	authMap.put("/like/fashionView.do", 1);
	authMap.put("/like2/timeView.do", 1);
