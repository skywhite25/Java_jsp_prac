...
<style>
@charset "utf-8";
html{background-color:#f5f6f7;}body{background-color:#f5f6f7;}
input[type=text]{
  padding: 0px 20px;
  height: 51px;
  margin: 4px 0;
...
제 16 조 (재판관할)
 1. 사이트와 이용자 간에 발생한 서비스 이용에 관한 분쟁에 대하여는 대한민국 법을 적용하며, 본 분쟁으로 인한 소는 대한민국의 법원에 제기합니다.
	...
	<button id="cancelBtn" class="cancelBtn" class="btn btn-primary">취소</button> <button id="writeBtn" class="writeBtn" class="btn btn-primary">확인</button>
</div>
</body>
</html>