...
public class ImageUpdateService implements Service{
	...
	public ImageUpdateService() {
		...
		System.out.println("ImageUpdateService.ImageWriteService() 생성 완료");
	}
	
	public void setDAO(Object dao) {
		System.out.println("ImageUpdateService.setDAO().dao : " + dao);
	...
	public Object service(Object obj) throws Exception {
		...
		// 넘어오는 데이터 확인 
		System.out.println("ImageUpdateService.obj : " + obj);
